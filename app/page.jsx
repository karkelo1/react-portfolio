...
export default function Home() {
  return (
    <main className=" bg-emerald-100 sm:text-sm font-mono">
      <section className="min-h-screen">
        ...
        <section >
          <div className='p-2 text-sm-auto text-center '>
            ...
            <p className="text-md py-2 leading-8 text-gray-800">Creating websites or web applications using programming languages like HTML, CSS, and JavaScript, along with frameworks like <span className="text-teal-500">React and Tailwind.</span></p>
            ...
            <div className=' flex flex-wrap gap-3 auto-cols-auto'>
              <div className="text-center  bg-gray-100 hover:shadow-xl p-10 rounded-xl my-4 flex-1">
                ...
                <Image src={fullstyle} width={200} height={200} className="rounded-xl mx-auto my-auto" />
              ...
              <div className="text-center bg-gray-100 hover:shadow-xl p-10 rounded-xl my-3 flex-1">
                ...
                <Image src={flightcatcher} width={210} height={210} className="rounded-xl mx-auto my-auto" />
                <div className="flex justify-center mt-3">
              ...
              <div className="text-center bg-gray-100 hover:shadow-xl p-10 rounded-xl my-5 flex-1">
                ...
                <Image src={ravemap} width={200} height={200} className="rounded-xl mx-auto my-auto" />
                <div className="flex justify-center mt-3">
